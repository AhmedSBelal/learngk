            ...
            <form method="POST" action="{{ route("admin.courses.store") }}" enctype="multipart/form-data">
                ...
                @foreach(siteLanguages() as $locale)
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has($locale.'.days') ? 'is-invalid' : '' }}" type="text"
                               name="{{$locale}}[days]" id="{{$locale}}-days" value="{{ old($locale.'.days', '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            id="seo_description-{{$locale}}">{{ old($locale.'.seo_description') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has($locale.'.seo_keywords') ? 'is-invalid' : '' }}"
                                  ...
                                  id="seo_keywords-{{$locale}}">{{ old($locale.'.seo_keywords') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('exam_link') ? 'is-invalid' : '' }}" type="text"
                           name="exam_link" id="exam_link" value="{{ old('exam_link', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('course_type') ? 'is-invalid' : '' }}"
                        ...
                        <option value
                                disabled {{ old('course_type_id', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                        @foreach($course_types as $entry)
                            <option
                                value="{{ $entry->id }}" {{ old('course_type_id') == $entry->id ? 'selected' : '' }}>
                                {{ $entry->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('course_level') ? 'is-invalid' : '' }}"
                            name="course_level_id" id="course_level_id" required>
                        <option value="{{ null }}" {{ old('course_level_id') === null ? 'selected' : '' }}>
                            {{ trans('global.pleaseSelect') }}
                        </option>
                        @foreach($course_levels as $entry)
                            <option
                                value="{{ $entry->id }}" {{ old('course_level_id') == $entry->id ? 'selected' : '' }}>{{ $entry->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="course_attend_type" id="course_attend_type">
                        <option value
                        ...
                        @foreach(App\Models\Course::COURSE_ATTEND_TYPE as $key => $label)
                            <option
                                value="{{ $key }}" {{ old('course_attend_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('course_book') ? 'is-invalid' : '' }}" type="text" name="course_book"
                           id="course_book" value="{{ old('course_book', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('participant') ? 'is-invalid' : '' }}" type="number"
                           name="participant" id="participant" value="{{ old('participant', '') }}">
