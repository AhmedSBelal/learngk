        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.galleries.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('video') ? 'is-invalid' : '' }}" type="text" name="video"
                           id="video" value="{{ old('video', '') }}">
                    @if($errors->has('video'))
                        <div class="invalid-feedback">
                            {{ $errors->first('video') }}
                        </div>
                ...
                <div class="form-group">
                    <label class="required" for="type">{{ trans('cruds.gallery.fields.type') }}</label>
