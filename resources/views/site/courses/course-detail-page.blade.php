                ...
                <div class="col-lg-5 my-3">
                    ...
                    <div class="row justify-content-between mt-3">
                        <div class="col-lg-6 text-center">
                            <a href="{{ route('courses.enroll', $course->slug) }}" class="main-btn rounded">
                                {{ trans('website.course.enroll') }}
                            </a>
                        </div>
                        @if($course->exam_link)
                            <div class="col-lg-6 text-center">
            ...
            <div class="row mb-4 justify-content-between align-items-center">
                @if($prev != null)
                    <div class="col col-md-2">
                        <a href="{{ route('courses.detail', $prev->slug) }}"
                ...
                @if($next != null)
                    <div class="col col-md-2">
                        <a href="{{ route('courses.detail', $next->slug) }}"
                           class="blog-pagination-btn">
